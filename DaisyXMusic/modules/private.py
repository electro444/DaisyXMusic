...
def map(pos):
    if pos == 1:
        ...
        button = [[
                    InlineKeyboardButton("➕ Add me to your Group", url=f"https://t.me/EOMUSICBOT?startgroup=true")
                  ],
                  [
...
async def ghelp(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🟡 Click here for help 🟡", url=f"https://t.me/EOMUSICBOT?start")]])
    )
